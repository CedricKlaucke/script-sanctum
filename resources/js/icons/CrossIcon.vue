...
import checkHex from "../helpers/checkHex";
...
const color = checkHex(props.color);
const title = props.title || "Cross Icon";
</script>
...
<template>
    <svg :width="size" :height="size" viewBox="0 0 25 25">
        ...
        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            <g :fill="color" transform="translate(-467.000000, -1039.000000)">
                <path
